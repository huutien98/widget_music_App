...
private String luotThich;
    ...
    public BaiHat(String id, String title, String artist) {
        this.idBaiHat = id;
...
this.luotThich = luotThich;
    ...
    public Uri getURI() {
        return ContentUris.withAppendedId(android.provider.MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, Long.parseLong(idBaiHat));
    }
}