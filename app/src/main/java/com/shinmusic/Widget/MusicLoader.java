...
public class MusicLoader {
    ...
    public BaiHat getCurrent() {
    	String title  = cur.getString(cur.getColumnIndex(android.provider.MediaStore.Audio.Media.TITLE));
    	String artist = cur.getString(cur.getColumnIndex(android.provider.MediaStore.Audio.Media.ARTIST));
    	long duration = cur.getLong(  cur.getColumnIndex(android.provider.MediaStore.Audio.Media.DURATION));
    	String id       = cur.getString(  cur.getColumnIndex(android.provider.MediaStore.Audio.Media._ID));

		return new BaiHat(id, title, artist);
    }

    public BaiHat getNext() {
    	if (!cur.moveToNext())
    		cur.moveToFirst();
	...
	public void jumpTo(BaiHat song) {
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
		Editor editor = prefs.edit();
		editor.putString(LAST_SONG_TITLE, song.getTenBaiHat());
		editor.putString(LAST_SONG_ARTIST, song.getIdBaiHat());
		editor.commit();
