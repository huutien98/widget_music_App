...
public class MusicPlayer implements MediaPlayer.OnCompletionListener {
    ...
    public void setSong(BaiHat song) throws IllegalArgumentException, SecurityException, IllegalStateException, IOException {
        ...
        Log.d(TAG, "Changed song to: " + song.getTenBaiHat());
    }
